    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="p-4 grid grid-cols-2 gap-3">
          <div className="stat-card">
            ...
            <div>
              ...
              <div className="text-xs text-brand-n500 font-medium">Trabajadores activos</div>
            </div>
          </div>
          <div className="stat-card">
            ...
            <div>
              ...
              <div className="text-xs text-brand-n500 font-medium">Con herramientas asignadas</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="panel">
        ...
        {conMantencion.length === 0 ? (
          <div className="p-6 text-center text-sm text-brand-n500">No hay equipos asignados con mantención programada.</div>
        ) : (
            ...
            {conMantencion.map(h => (
              <div key={h.id} className="p-3 flex items-center justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <div className="text-xs text-brand-n500 truncate">{h.responsable}</div>
                </div>
