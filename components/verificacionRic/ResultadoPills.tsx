...
const OPCIONES: { value: Exclude<Resultado, null>; label: string; activeClass: string }[] = [
  { value: 'pasa',    label: 'Pasa',    activeClass: 'bg-emerald-600 text-white border-emerald-600' },
  { value: 'no_pasa', label: 'No pasa', activeClass: 'bg-red-600 text-white border-red-600' },
  { value: 'na',      label: 'N/A',     activeClass: 'bg-slate-500 text-white border-slate-500' },
]

export default function ResultadoPills({ value, onChange, disabled }: {
