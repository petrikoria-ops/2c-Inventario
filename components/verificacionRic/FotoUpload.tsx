...
import { subirFotoVerificacion, getSignedUrl } from '@/lib/supabase/storage'
...
export default function FotoUpload({ verificacionId, itemId, fotoUrl, disabled, onUploaded, onRemoved }: Props) {
  ...
  const handleFile = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setLoading(true)
    try {
      const path = await subirFotoVerificacion(getSupabaseBrowser(), verificacionId, itemId, file)
      onUploaded(path)
